...
- 식별 요약 링1 함수(#88, A-1-15) — 슬라이스 2 PR-1 착지: 임시 요약을 폐기하고
  :func:`~hwpxfiller.core.identity_summary.identity_summary` 를 소비한다(집합 위 1회 판정,
  행별 :meth:`~hwpxfiller.core.identity_summary.IdentitySummary.summary_for` 병기).
