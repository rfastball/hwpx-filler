...
# describe_result_error(RC-30) 는 Qt 비의존 순수 문자열 로직 → result_errors 로 분리해
# 위젯(run/matrix)과 webview 컨트롤러(webapp.screen_run)가 함께 쓴다. 여기선 하위호환 재export.
from .result_errors import describe_result_error  # noqa: F401  (재export)
