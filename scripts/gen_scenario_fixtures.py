...
# 정합한다(입찰개시·입찰마감·개찰 모두 일자/시각으로). 직접 매칭 경로라 값은 원문(서식 미적용).
FIELDS = [
    "입찰공고번호", "수요기관", "공고명", "계약방법", "세부품명",
    "사업예산", "추정가격", "수량", "분할납품", "입찰방법",
    "낙찰자결정방법", "납품기한", "인도조건", "하자담보기간", "입찰개시일자",
    "입찰개시시각", "입찰마감일자", "입찰마감시각", "개찰일자", "개찰시각",
    "등록마감일시", "담당부서", "담당자", "담당자 전화번호", "세부품명번호",
]
...
RECORDS = [
    {
        ...
        "하자담보기간": "1년", "입찰개시일자": "2026-07-15", "입찰개시시각": "09:00",
        "입찰마감일자": "2026-07-21", "입찰마감시각": "17:00",
        "개찰일자": "2026-07-22", "개찰시각": "10:00",
    ...
    },
    {
        ...
        "하자담보기간": "2년", "입찰개시일자": "2026-07-16", "입찰개시시각": "09:00",
        "입찰마감일자": "2026-07-22", "입찰마감시각": "17:00",
        "개찰일자": "2026-07-23", "개찰시각": "10:00",
    ...
    },
    {
        ...
        "하자담보기간": "3년", "입찰개시일자": "2026-07-18", "입찰개시시각": "09:00",
        "입찰마감일자": "2026-07-25", "입찰마감시각": "17:00",
        "개찰일자": "2026-07-26", "개찰시각": "10:00",
...
BID_NOTICE_LINES = [
    ...
    "인도조건: {{인도조건}}",
    "하자담보기간: {{하자담보기간}}",
    "입찰개시일시: {{입찰개시일자}} {{입찰개시시각}}",
    "입찰마감일시: {{입찰마감일자}} {{입찰마감시각}}",
    "개찰일시: {{개찰일자}} {{개찰시각}}",
    "등록마감일시: {{등록마감일시}}",
    "담당부서: {{담당부서}}",
    "담당자: {{담당자}}  전화 {{담당자 전화번호}}",
