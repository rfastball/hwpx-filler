...
| F6 | TXT 합류 + 작업대 → `draft` 흡수·사망(휘발 세션 폐지 고지) **+ F5 드로어 행별 「수정」 deep-link 동승**(§10.14.3) — **PR 2분할**: ~~A~~ **착지**(TXT 합류·작업대 신설, `draft` 존치) PR #315 squash `275dd24` · 계약 §10.15 · 정산 §10.15.4 · 리뷰 9라운드 §10.15.5~§10.15.13 · 결산 §10.15.14 / **B 남음**(`draft` 사망·승계 정산·deep-link·101 트랙 B 재배선) | 17·18·19 |
