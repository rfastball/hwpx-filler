...
| F2 | 전역 라이브러리 표면(browser+detail) + 상단 2탭 → `home` 흡수·사망 — **PR 2분할**: ~~A(표면·`home` 사망)~~ **착지**(계약 §10.8, PR #309 squash `446e081`) / **B**(셸 교체·좌 목록 사망) **착수**(계약 §10.9) | 14·15·1 |
...
| 2 | 데이터 없는 상태의 작업 선택 | **없음 — 흡수**(판정 C). 출구만 상주 | 신설(출구) |
