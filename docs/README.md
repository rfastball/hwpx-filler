...
| `tests/kernel_boundary_contract.toml` | **임시 축소 원장**(P3-02 #592) — census ID별 legacy consumer/definition/export와 kernel/vendor residual의 exact allowlist. 이동과 같은 변경에서 줄이고 P3-99에서 census와 함께 처분 |
