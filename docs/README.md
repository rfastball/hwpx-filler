...
| [HWPX structural range S0 관찰](HWPX_STRUCTURAL_RANGE_S0.md) | 유효 결정 | native R0~R5·T0~T7 증거와 `hwpxcore.bookmark_region` production 계약. R5(§19)가 proper nesting 을 증명했고 §20에서 resolve 가 containment 를 내도록 넓혔다 — crossing 거부와 nested 제거 금지는 유지 |
