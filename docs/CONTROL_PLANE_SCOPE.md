...
| shipping Profile 상수 + manifest | `external/template_inspection.py` (`HWPX_QUALIFICATION_PROFILE` id `hwpx-template-qualification-v4`·`hwpx_qualification_manifest`) | `webapp/template_change.py` |
