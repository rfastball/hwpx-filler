...
작업의 저장·실행 규칙은 [작업 흐름](docs/workflow.md)을 따른다.
...
키보드·초점·ARIA, reduced motion과 대비 규칙은 [화면 규칙](docs/ui-style.md#ui-visual)을 따른다.
...
등록 목록·버전은 [런타임 참조](docs/reference/runtime.md)를 따른다.
