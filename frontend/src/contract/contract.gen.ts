...
export const SCREEN_ACTIONS = {
  library: {
    ...
    toggle_facet: { required: ["axis", "value"], optional: [] },
    clear_facets: { required: [], optional: [] },
    clear_filters: { required: [], optional: [] },
    toggle_group: { required: ["group"], optional: [] },
  ...
  job: {
    ...
    set_group: { required: ["name"], optional: ["group"] },
    rename_group: { required: ["name"], optional: ["confirm", "new", "seen"] },
    disband_group: { required: ["name"], optional: ["confirm", "seen"] },
  },
  workbench: {
  ...
  tpl: {
    ...
    set_group: { required: ["key", "media"], optional: ["group"] },
    toggle_group: { required: ["group", "media"], optional: [] },
    rename_group: { required: ["group", "media"], optional: ["confirm", "new"] },
    disband_group: { required: ["group", "media"], optional: ["confirm"] },
