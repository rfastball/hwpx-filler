...
정본: https://github.com/rfastball/hwpx-filler/blob/5f51e442dde87891b68fbbdc1519a04e01211b8e/docs/archive/DATA_FIRST_INTEGRATION_MAP.md (봉합 지도) · docs/workflow.md#workflow-definition (계약).
